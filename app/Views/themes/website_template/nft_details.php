<?php
    ...
    if ($err) {
        ...
        if($nftInfo->lockable == ''){
            ...
            $button = '<a href=" '. $nftInfo->lockable .'" class="btn btn-l btn-pills btn-outline-primary me-2 bid-btn" download><i class="mdi mdi-gavel fs-5 me-2"></i>Download Item</a>';
            $table = 'Yes';
                            ...
                            <div class="timer-container position-relative mt-3"> 
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <h2 class="mb-0 fw-bold"><?php echo number_format(esc($nftInfo->price), 6, '.', ',') .' '.$chain; ?></h2> 
                                        <h6 class="mb-0 fw-bold"><?php 
                                        if($chain == 'matic'){
                                             echo  number_format(esc($matic * $nftInfo->price), 2, '.', ',').' USD ' ; 
                                        }else{
                                             echo  number_format(esc($value * $nftInfo->price), 2, '.', ',').' USD ' ; 
                                        }
                                    ...
                                    <div class="tab-content mt-4 pt-2" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade" id="bids" role="tabpanel" aria-labelledby="bids-tab">
                                            ...
                                            <div class="creators creator-primary d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    <h6 class="mb-0"><?php echo number_format($bidInfo->bid_amount, 6, '.',',').' '.$chain; ?> <span class="text-muted">by</span> 
                                ...
                                <table class="table table-sm table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo esc($amount).' '.$chain; ?></td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo esc($type); ?></td>
                                            <td><?php echo esc($listing->min_price).' '.$chain; ?></td>
                        ...
                        <div class="card nft-items nft-primary rounded-7 border-0 overflow-hidden mb-1 p-4">
                            ...
                            <div class="card-body content position-relative mt-3">
                                ...
                                <div class="d-flex justify-content-between mt-2">
                                    <small class="rate fw-semi-bold text-primary"><?php echo number_format(esc($moreNfts->price), 5).' '.$chain; ?></small> 
                                    <small class="rate fw-semi-bold text-primary">
                                        <?php 
                                        if($chain == 'matic'){
                                            echo 'USD '.number_format(esc($matic * $moreNfts->price), 2);
                                        }else{
                                            echo 'USD '.number_format(esc($value * $moreNfts->price), 2);
                                        }
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-4 p-xl-5">
                        <input type="hidden" name="buyerWallet" id="buyerWallet" value="<?php echo esc($loggedinWallet); ?>">
                         ...
                         <input type="hidden" name="sellerWallet" id="sellerWallet" value="<?php echo esc($nftInfo->owner_wallet); ?>">
                          <input type="hidden" name="type_nft" id="type_nft" value="<?php echo esc($nftInfo->type); ?>">
                           <input type="hidden" name="nft_part" id="nft_part" value="<?php echo esc($nftInfo->file); ?>">
                           
                            <input type="hidden" name="nft_net" id="nft_net" value="<?php echo esc($nftInfo->net); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><?php echo $chain; ?></span>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-xl-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4"> 
                                <div class="mb-0 fw-bold">Total : <?php echo number_format(esc($nftInfo->price), 6, '.', ',') .' '.$chain; ?></div> 
                            </div>
                        </div>
                        
                        <div class="fs-5 text-dark mt-3 text-center">
                            You Need : <?php echo number_format(esc($nftInfo->price), 6, '.', ',') .' '.$chain; ?> +  Gas Fees
