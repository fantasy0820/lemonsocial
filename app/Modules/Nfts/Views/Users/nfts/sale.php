    ...
    <div class="container">
        ...
        <span class="text-danger te"><?php echo display('Gas_fees_will_be_deducted_from_your_wallet'); ?></span><br>
            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="auction-tab">
                ...
                <div class="row">
                    <div class="col-md-7"> 
                        <input type="hidden" name="nft_net" id="nft_net" value="<?php echo $nftInfo->net; ?>">
                        ...
                        <input type="hidden" name="end_date" value="" class="end_date">
                          ...
                          <?php
                                ...
                                ?>
                                <input type="hidden" value="1" id="freemint" />
                                  <?php }else{ ?>
                                
                                 <input type="hidden" value="false" id="freemint" />
                            ...
                            <div class="g-3 row">
                                <div class="col-md-4">
                                    <select class="form-select" aria-label="Default select example" disabled>
                                        <option selected><?php echo $nftInfo->net; ?><?php //echo SYMBOL(); ?></option> 
                                    </select>
                                </div>
                                <div class="col-md-8">
                         ...
                         <div class="mb-4"> 
                            <div class="listing-submit">
                                ...
                                ?>
                                 ...
                                 <button onclick="toasterMessage('warning', 'Free minting can only be listed with a fixed price');"   type="button" class="btn btn-primary"><?php echo display('Complete_listing'); ?></button>
                                <?php }else{ ?>
